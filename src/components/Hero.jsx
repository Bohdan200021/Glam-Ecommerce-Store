    ...
    >
      <div className="relative max-w-[777px] top-44 xs:top-60">
        <h2 className="h1 capitalize max-w-[611px]">
          Elevate your wardrope with trendy fashion from
        ...
        <div className="flex gap-x-10 max-md:flex-col-reverse mt-28">
          ...
          <p className="my-2">
            ...
            neque a corrupti veritatis aperiam architecto nostrum omnis,
            distinctio magni doloremque corporis quibusdam nulla ratione.
          </p>
        </div>
      </div>
    </section>
